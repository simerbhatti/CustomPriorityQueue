...
/**
 * 
 * The CustomPriorityQueue class has a PriorityQueue that stores the items in
 * the queue. The ConcurrentHashMap throttleMap stores the throttle rate of each
 * priority class. The queueSemaphore is used to control the size of the queue.
 * 
...
public class CustomPriorityQueue<T> {
	 ...
	 * queue is full. It then adds the item to the priority queue and creates a new
	 * semaphore for the priority class if it doesn't already exist.
	 * 
	 * @param item
	 * @param priority
	 ...
	 * queue and acquires the semaphore for the priority class. It then releases the
	 * queueSemaphore to allow more items to be added to the queue.
	 * 
	 * @return
	 * @throws InterruptedException
	 */
